...
“This project made a huge amount of progress to take the app from an MVP to something that is mature enough to be useful for dRTPs. The web app is by no means complete, but locking down the structure of the framework has made it possible to develop more features in future projects that will really make DIRECT a fantastic resource.”

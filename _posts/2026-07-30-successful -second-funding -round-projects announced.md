...
The eligible applications were submitted from 13 institutions in total (only one less than the first round), although representation was heavily skewed towards England and Russell Group universities. Notably, no applications were received from non-Russell Group universities, and we again did not receive any applications from Northern Ireland, indicating important outreach gaps for future rounds. 

The applicant pool showed a 63% male / 37% female split and was predominantly White (88%), with no Black applicants, mirroring disparities seen in [related sector surveys](https://discourse-network.github.io/news/2026/03/13/flex-fund-round-1-outcomes/#reference-surveys-used). Career stage participation was strongest among mid-career applicants but not as strongly so compared to our first funding round.   

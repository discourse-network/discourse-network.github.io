...
**Register via <https://bit.ly/dRTP_landscape_workshop> before noon on Tuesday 28th October 2025.**

This joint event, co-organised by [CHARTED](https://drtp-skills.ac.uk/) and SCALE-UP, aims to:
...
We would be happy to provide support for a few participants whose organisation/projects cannot cover travel costs. If you would like to attend the event but need any travel support, please apply for the travel support by answering the relevant questions in the [registration form](https://bit.ly/dRTP_landscape_workshop).

---
layout: single
title: "DisCouRSE Flexible Fund - Round 1"
permalink: /funding/round-1
toc: true
toc_sticky: true
---
...
| Monday 6<sup>th</sup> October 2025,<br> 10:00 BST | Informative webinar with Q&A |
...
Applicants based in UK business, third sector or government organisations cannot lead a project (or take over as lead later) but may be included as project co-leads.
...
3. Choose the appropriate application form “DisCouRSE - Flexible Funding Call - Round 1” and click on “Begin application”
...
We will operate a rapid two stage assessment process. Decisions will be communicated within 1 month of the call closing to allow projects to start promptly. However we reserve the right to modify this process if required.
...
Funded projects must provide short (typically single paragraph) monthly written reports to the DisCouRSE Management Board following a provided template. Financial invoices must be provided quarterly to UCL, with timesheets for all directly incurred staff as required by UKRI.

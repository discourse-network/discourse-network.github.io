---
layout: single
title: "DisCouRSE Flexible Fund - Round 3 - Frequently Asked Questions"
permalink: /funding/round-3/faq
toc: true
toc_sticky: true
---

The [third round of the DisCouRSE Network's Flexible Funding scheme](/funding/round-3) is accepting applications until **16:00 GMT on 11<sup>th</sup> December 2026**.
...
: Potentially but unlikely, especially for this round as it doesn't fit within a focus area. You would have to consider how it relates particularly to the leadership aspect of career pathways. Outreach tends to be more done at the entry level of the profession particularly if you are targeting undergraduates. However if your focus is more on developing the leaders who can effectively run those kinds of outreach events and build pathways that could be within scope. It might however fit better with some of the [other Network+ projects](https://www.cake.ac.uk/funds/) and we encourage you to apply to them instead.

Can staff time be used to develop software that facilitates the project outputs?
: Yes, staff time is allowed to develop software as long as it is justified in terms of the project objectives and the overall project is in scope. With a few exceptions, as in previous rounds, a proposal focused on software development is unlikely to be funded.
...
: Yes but with some constraints.  We’ve referred to this in the [costing principles section](/funding/round-3#costing-principles).  The amount of money going outside of the research sector (i.e. academia, research labs) must not exceed 50% of the total budget for the project.
...
: Yes, albeit noting the constraint that all proposed training needs to engage with the [dRTP Skills Landscape Coordination Group](https://zenodo.org/records/21496700) to avoid duplication. It’s something that universities often provide but it’s unclear how much it's available outside of universities.

Are existing projects or services eligible to apply for funding under this call? If so, are there any particular expectations around how ongoing initiatives should frame their proposals in relation to the aims of DisCouRSE (e.g., leadership training, community building, or career pathways)?
...
Since most dRTPs work on fixed term contracts, is there any requirement as to the minimum time left in their contract to be a project (co-)lead?
...
: The co-leads of DisCouRSE cannot be leads or co-leads of proposals.  However other members of the DIRECT framework team can be named. Such a project would be classified as a strand 2 'growth project'.
...
Are UKRI Independent Research Organisations (IRO) considered as "Academia" for the purpose of pilot or growth projects needing to have 50% of costs to academia?
...
: Each UK institution calculates the full economic cost of research to them.  This varies between each institution as costs differ between them.  To run a research project there are many other costs beyond those directly related to the project (such as paying salaries for the staff working on that project).  For example, the costs of the building the people work in, support staff, estates management, etc.  These comprise the “indirect” costs associated with the research project.  UK public research funders don’t cover 100% of those costs - they will only cover 80% of the total budget including them.  We have some [tables and guidance on our funding call webpage](/funding/round-3#funding-and-duration) and a [separate guidance document explaining this in more detail](/funding/guide).

Can projects in this round last less than a year?
: Yes. They cannot last beyond the end date specified but may finish earlier.


# Miscellaneous

Will the Town Hall slides be uploaded to the funding call page?
: Yes, probably a few days after the event.
...
What do we do if we've had an idea but can't fit it within the budget ceiling?
: We are unlikely to raise the ceiling for either strand in our final two rounds, so consider re-scoping your project to begin with what can be delivered within the budget and seek follow-on funding later -- or look for a partner that can also contribute financially.

---
title: "DIRECT Web Development II"
...
[The DIRECT framework](https://directframework.com/) is a framework of skills and competencies for dRTPs. This project will continue the development of the [DIRECT Web App](https://github.com/direct-framework/direct-webapp), which provides an accessible way for the community to explore the framework and understand the skills, competencies and categories it contains.
...
- Creating a community contribution mechanism for the Framework.
- Creating example jobs/roles and career pathways.
- Including community of practice or “value” areas.

Together, these developments will further support the community in using, contributing to and engaging with the DIRECT framework.
